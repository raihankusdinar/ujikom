...
<div class="container mt-3">
  ...
  <div class="row">
    ...
    if (isset($_GET['albumid'])) {
      ...
      <div class="card">
        <img src="../asset/img/<?php echo $data ['lokasifile'] ?>" class="card-img-top" title="" style="height: 12rem;"  title="<?php echo $data ['judulfoto'] ?>"> 
 ...
 ?>
  <div class= "col-md-3 mt-2">
      <div class="card">
        ...
        echo mysqli_num_rows($like). ' Suka';
        ?>
        <a href=""><i class="fa-regular fa-comment"></i></a> 3 Komentar </div>
      </div>
    </div>
<?php } } ?>
 </div>
